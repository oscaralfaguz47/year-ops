...
{
    /// <inheritdoc />
    public partial class fiveUpdateSP_CONSULTANT_REIMBURSED_BENEFITS_GetApprovedBenefitsWhereConsultantInThePeriod : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            SELECT 
                CRB.ReimbursedBenefitId AS MovementId,
                BMT.MovementTypeId,
            ...
            INNER JOIN CONSULTANT_BENEFIT_CATEGORIES CBC ON CRB.BenefitCategoryId = CBC.BenefitCategoryId
            ...
            WHERE CRB.ConsultantId = @ConsultantId
              ...
              AND CBC.Name <> 'Expert Boost ($250) (2500 Bonus.ly XP)'
