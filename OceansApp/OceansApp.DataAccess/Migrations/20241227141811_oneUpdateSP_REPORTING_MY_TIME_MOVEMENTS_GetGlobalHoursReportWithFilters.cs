...
{
    /// <inheritdoc />
    public partial class oneUpdateSP_REPORTING_MY_TIME_MOVEMENTS_GetGlobalHoursReportWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            //UPDATE STORED PROCEDURE
            var sp = @"CREATE PROCEDURE SP_REPORTING_MY_TIME_MOVEMENTS_GetGlobalHoursReportWithFilters
             ...
             ORDER BY 
                 CL.Name, PR.Name, U.Name, TM.ActionDate;
             END;";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var spOriginal = @"CREATE PROCEDURE addSP_REPORTING_MY_TIME_MOVEMENTS_GetGlobalHoursReportWithFilters
             @ProjectIds IntTableType READONLY,
             @ClientIds IntTableType READONLY,
             @ConsultantIds IntTableType READONLY,
             @StartDate DATE,
            ...
            migrationBuilder.Sql("DROP PROCEDURE IF SP_REPORTING_MY_TIME_MOVEMENTS_GetGlobalHoursReportWithFilters");
