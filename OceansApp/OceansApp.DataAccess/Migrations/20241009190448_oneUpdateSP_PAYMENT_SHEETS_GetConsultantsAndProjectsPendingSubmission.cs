...
{
    /// <inheritdoc />
    public partial class oneUpdateSP_PAYMENT_SHEETS_GetConsultantsAndProjectsPendingSubmission : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            -- Application of OUTER APPLY for AccessToTrackingToolData
            ,PagedResults AS (
                SELECT
                    CD.ConsultantId,
                    P.ProjectId,
