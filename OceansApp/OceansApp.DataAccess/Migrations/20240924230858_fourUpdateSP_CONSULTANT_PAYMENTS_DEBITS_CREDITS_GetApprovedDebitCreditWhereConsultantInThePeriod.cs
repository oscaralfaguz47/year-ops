...
{
    /// <inheritdoc />
    public partial class fourUpdateSP_CONSULTANT_PAYMENTS_DEBITS_CREDITS_GetApprovedDebitCreditWhereConsultantInThePeriod : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            BEGIN
            SELECT 
              CPDC.ConsultantPaymentDebitsCreditsId AS MovementId
