...
{
    /// <inheritdoc />
    public partial class threeUpdateSP_INTERVIEWS_GetAllInterviewsWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            @FieldToOrder VARCHAR(100),
            @DirectionOrder VARCHAR(100),
            @Skip INT,
            @Take INT,
            ...
            OR LOWER(I.Detail) LIKE '%' + LOWER(@SearchText) + '%')
