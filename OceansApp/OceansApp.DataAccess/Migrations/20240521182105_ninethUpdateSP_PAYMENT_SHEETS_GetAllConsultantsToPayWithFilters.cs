...
{
    /// <inheritdoc />
    public partial class ninethUpdateSP_PAYMENT_SHEETS_GetAllConsultantsToPayWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            FROM (
                ...
                AND CONVERT(DATE, SCRMTS.StartPeriodDate) = @StartDateFormatted
                AND CONVERT(DATE, SCRMTS.EndPeriodDate) = @EndDateFormatted
