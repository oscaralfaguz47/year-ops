...
{
    /// <inheritdoc />
    public partial class twentyThreeUpdateSP_PAYMENT_SHEETS_GetAllConsultantsToPayWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            ActiveConsultants AS (
                ...
                WHERE
                    ...
                    AND NOT EXISTS (
                        -- Exclude consultants deactivated before the StartDate unless reactivated before or during the period
                        SELECT 1
