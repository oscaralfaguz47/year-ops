...
{
    /// <inheritdoc />
    public partial class seventhUpdateSP_PAYMENT_SHEETS_GetAllConsultantsToPayWithFilters : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            GROUP BY CONCAT(U.Name, ' ', U.LastName), CD.ConsultantId, P.ProjectId, P.Name, RS.SubmissionId, 
            TS.Name, RS.SubmissionDate, RS.LastSubmissionDate
