...
namespace OceansApp.DataAccess.Migrations
{
    ...
    [Migration("20240424193434_secondUpdateSP_PROJECTS_CONSULTANTS_ASSIGNED_GetConsultantSelectedProjectInfo")]
    partial class secondUpdateSP_PROJECTS_CONSULTANTS_ASSIGNED_GetConsultantSelectedProjectInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OceansApp.Models.Models.PaymentSheet", b =>
                {
                    b.Property<int>("PaymentSheetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PaymentSheetId"));

                    b.Property<int>("ConsultantDetailCreatedByConsultantId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PaymentSheetId");

                    b.HasIndex("ConsultantDetailCreatedByConsultantId");

                    b.ToTable("PAYMENT_SHEETS");
                });
            ...
            modelBuilder.Entity("OceansApp.Models.Models.ProjectConsultantAssignedHistory", b =>
                {
                    ...
                    b.Property<string>("NewValueDetail")
                        .HasMaxLength(130)
                        .HasColumnType("nvarchar(130)");
                    ...
                    b.Property<string>("OldValueDetail")
                        .HasMaxLength(130)
                        .HasColumnType("nvarchar(130)");
            ...
            modelBuilder.Entity("OceansApp.Models.Models.ProjectConsultantAssignedHistoryAction", b =>
                {
                    b.Property<int>("ActionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OceansApp.Models.Models.ReportingMyTimeMovementSubmissions", b =>
                {
            ...
            modelBuilder.Entity("OceansApp.Models.Models.PaymentSheet", b =>
                {
                    b.HasOne("OceansApp.Models.Models.ConsultantDetail", "ConsultantDetailCreatedBy")
                        .WithMany()
                        .HasForeignKey("ConsultantDetailCreatedByConsultantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OceansApp.Models.Models.ProjectConsultantAssignedHistory", b =>
                {
                    b.HasOne("OceansApp.Models.Models.ProjectConsultantAssignedHistoryAction", "Action")
                        .WithMany()
