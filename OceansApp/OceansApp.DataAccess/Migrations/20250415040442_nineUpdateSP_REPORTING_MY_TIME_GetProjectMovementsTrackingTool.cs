...
{
    /// <inheritdoc />
    public partial class nineUpdateSP_REPORTING_MY_TIME_GetProjectMovementsTrackingTool : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            -- Get @IsDefaultProject and @NumHoursForHoliday
            SELECT TOP 1 
            ...
            WITH TimeMovements AS (
                SELECT 
                    ...
                    MT.IsPayable,
                    M.Notes,
                    CAST(0 AS BIT) AS IsHoliday -- ❄ No es holiday
                FROM REPORTING_MY_TIME_MOVEMENTS AS M
                INNER JOIN TRANSACTION_STATUSES AS TS 
                    ON M.TransactionStatusId = TS.TransactionStatusId
            ...
            HolidayDates AS (
                SELECT 
                    ...
                    '08:00' AS TimeFrom,
                    FORMAT(DATEADD(MINUTE, @NumHoursForHoliday * 60, '08:00'), 'HH:mm') AS TimeTo,
                    @TransactionStatusName AS TransactionStatusName,
                    1 AS IsPayable,
                    CHD.Name AS Notes,
                    CAST(1 AS BIT) AS IsHoliday -- ☀ Es holiday
