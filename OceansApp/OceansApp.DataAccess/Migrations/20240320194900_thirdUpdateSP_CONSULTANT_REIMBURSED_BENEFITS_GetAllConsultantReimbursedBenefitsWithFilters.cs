...
{
    public partial class thirdUpdateSP_CONSULTANT_REIMBURSED_BENEFITS_GetAllConsultantReimbursedBenefitsWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            JOIN TRANSACTION_STATUSES TS ON CRB.TransactionStatusId = TS.TransactionStatusId
	        ...
	        AND (@TransactionStatusId IS NULL OR CRB.TransactionStatusId = @TransactionStatusId)
