...
{
    /// <inheritdoc />
    public partial class sevenUpdateSP_CONSULTANT_DETAILS_GetAllConsultantsWithFilters : Migration
    {
        ...
        LEFT JOIN IMAGE_BLOBS IB ON CD.UserId = IB.EntityId AND IB.ContainerName = 'user-profile-photos' 
