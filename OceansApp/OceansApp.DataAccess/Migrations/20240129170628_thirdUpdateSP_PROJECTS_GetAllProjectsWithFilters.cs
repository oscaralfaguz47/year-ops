...
{
    public partial class thirdUpdateSP_PROJECTS_GetAllProjectsWithFilters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            //UPDATE STORED PROCEDURE
            var sp = @"CREATE PROCEDURE SP_PROJECTS_GetAllProjectsWithFilters
      ...
      ,P.ClientHasTrackingTool
       ...
       AND (@SuccessManagerId IS NULL OR CD.ConsultantId = @SuccessManagerId)
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var spOriginal = @"CREATE PROCEDURE SP_GetAllProjectsWithFilters
    @SearchText NVARCHAR(255),
    @StartDate DATE,
    @EndDate DATE,
    @IsActive BIT,
      ...
      ,P.ClientHasTrackingTool
       ...
       AND (@SuccessManagerId IS NULL OR CD.ConsultantId = @SuccessManagerId)
        ...
        END";
            ...
            migrationBuilder.Sql("DROP PROCEDURE IF SP_PROJECTS_GetAllProjectsWithFilters");
